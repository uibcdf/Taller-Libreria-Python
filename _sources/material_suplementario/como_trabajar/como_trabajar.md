...
[github.com/uibcdf/Taller-Libreria-Python][repositorio].
...
Activas el ambiente de trabajo -supongamos que lo llamaste "Taller-Libreria-Python"-:
```bash
conda activate Taller-Libreria-Python
```
...
[repositorio]: https://www.github.com/uibcdf/Taller-Libreria-Python
...
[discussions]: https://github.com/uibcdf/Taller-Libreria-Python/discussions
[semana_1_preguntas]: ../../semana_1/preguntas.md
[repo_semana_1_preguntas]: https://github.com/uibcdf/Taller-Libreria-Python/blob/main/semana_1/preguntas.md
